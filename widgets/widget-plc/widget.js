...
cprequire_test(["inline:com-chilipeppr-widget-plc"], function(myWidget) {
...
cpdefine("inline:com-chilipeppr-widget-plc", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-widget-plc", // Make the id the same as the cpdefine id
        name: "Widget / plc", // The descriptive name of your widget.
        desc: "This example widget gives you a framework for creating your own widget. Please change this description once you fork this plc and create your own widget. Make sure to run runme.js every time you are done editing your code so you can regenerate your README.md file, regenerate your auto-generated-widget.html, and automatically push your changes to Github.", // A description of what your widget does
            ...
            .done(function(res){
                ...
                if(res){
                   localStorage.setItem('statusPlc', res);
                    ...
                    if(parseInt(res.carrusel)) $('.select-pocket').attr('disabled', 'disabled');
            ...
            .done(function(res){
               ...
               res = JSON.parse(res);
                if(parseInt(res.status) == 1){
                    ...
                    var newMessage = (status == 1) ? "Liberar " : "Contraer";
                    $(name + " span").html(newMessage);
                    $(name).attr('content', newStatus);
                    if(name == '#carusel'){
                        if(newStatus == 1) $('.select-pocket').attr('disabled', 'disabled');
                        else $('.select-pocket').removeAttr('disabled');
                    }
                } 
            })
            .fail(function(err){
